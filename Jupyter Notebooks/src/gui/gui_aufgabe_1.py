...
class GUI:
    ...
    def gui_elements(self):
        ...
        slider_d, slider_c, c_input_max, slider_defl, slider_v, slider_m = (
            self.variables_control_elements()
        )
        # make slider grid
        slider_grid = VBox(
            [slider_d, slider_c, c_input_max, slider_m, slider_defl, slider_v]
        )
    ...
    def variables_control_elements(self) -> widgets:
        ...
        slider_m = widgets.FloatSlider(
            ...
            readout=True,
            readout_format=".2f",
            layout=widgets.Layout(left="-14%", width="90%", display="flex"),
        )
        ...
        slider_v = widgets.FloatSlider(
            ...
            readout=True,
            readout_format=".4f",
            layout=widgets.Layout(left="-12%", width="88%", display="flex"),
        )
        ...
        return slider_d, slider_c, c_input_max, slider_defl, slider_v, slider_m
    ...
    def place_gui_elements(
        ...
        # make tab for graphs
        tab = widgets.Tab()
        # tab_contents = ["Deflection", "Other"]
        children = [self.fig.canvas, self.fig.canvas]
        tab.children = children
        tab.titles = ["Deflection", "Other"]

        app_layout = AppLayout(
            header=title_grid,
            left_sidebar=interactive_grid,
            center=self.mult_canvas_anim,
            right_sidebar=tab,  # self.fig.canvas,
            footer=None,
